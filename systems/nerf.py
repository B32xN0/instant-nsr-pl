    ...
    def training_step(self, batch, batch_idx):
        ...
        if "robust_loss" in self.config.system.loss and self.config.system.loss.robust_loss:
            ...
            with torch.no_grad():
                ...
                # TODO applies an unnecessary sqrt, but we only use relative anyhow so does not hurt, still a bit ugly
            ...
            # TODO the sampling of patches is not compatible with the occupancy grid technique and can lead to divergence
